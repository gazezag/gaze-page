...
//数据
var dataXName = ['1', '2', '3', '4', '5'];
var DNS = [66, 50, 43, 55, 37];
var TCP = [66, 50, 43, 55, 37];
var SSL = [66, 50, 43, 55, 37];
var TTFB = [66, 50, 43, 55, 37];
var transmit = [66, 50, 43, 55, 37];
var domParse = [66, 50, 43, 55, 37];
var redirect = [55, 42, 46, 75, 38];
var domContentLoadedCallback = [40, 20, 65, 25, 30];
var L = [40, 20, 65, 25, 30];

var dataYline = [40, 20, 65, 25, 30];
